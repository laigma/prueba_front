...
module.exports = env => {
  ...
  console.log('Integration: ', env.integration); // Entorno de integración
  ...
  return {
    ...
    plugins: [
      new Dotenv({
        path: `./.env.${env.development == true ? "development" : env.integration == true ? "integration" : "production"}`,
        safe: true
      }),
    ...
    module: {
      ...
      {
        test: /\.(png|jpg|pdf|eot|ttf|woff2|woff|gif)$/,
        use: [
          {
            loader: 'file-loader',
            options: {
